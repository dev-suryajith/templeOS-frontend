...
function Login() {
  ...
  const handleSubmit = async () => {
    (!formData?.email || !formData?.password) && setLoginFlag('Fill all credentials')
    try {
    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 style={{ fontFamily: 'Gelasio' }} className="mt-4 text-2xl font-bold text-[#7d1f1d] text-center">
            SRI NARASIMHASWAMI
          </h1>

          <p style={{ fontFamily: 'Gelasio' }} className="text-[#b85e5d] text-sm mt-1">
        ...
        <form className="space-y-5">
          <div className="relative">
            <input
              ...
              id="email"
              placeholder=" "
              onChange={(e) => setFormData({ ...formData, email: e.target.vale })}
          ...
          <div className="relative">
            <input
              ...
              id="password"
              placeholder=" "
              onChange={(e) => setFormData({ ...formData, password: e.target.vale })}
          ...
          <p style={{ fontFamily: 'Gelasio' }} className="text-[#ff0400] text-md my-3 ms-2">
            {loginFlag}
          </p>
          ...
          <button
            ...
            className="w-full bg-linear-to-br from-orange-500 via-amber-500
             to-orange-500
             hover:bg-linear-to-br hover:from-orange-700 hover:via-amber-700
             hover:to-orange-700
             text-white py-3 rounded-xl font-semibold transition duration-300 shadow-lg"
          >
            Login
          </button>
        </form>
